...
title = La Dinamica App

# (str) Package name
package.name = LDM_APP
...
requirements=python3,kivy==2.3.0,docutils,Kivy-Garden,kivy_garden.zbarcam,typing_extensions,pygments,pillow,sqlite3,png,qrcode,pypng,fpdf,plyer,pyzbar,xcamera,numpy,regex
