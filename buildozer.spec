...
requirements=python3,kivy==2.3.0,docutils,Kivy-Garden,typing_extensions,pygments,pillow,sqlite3,png,qrcode,pypng,fpdf,plyer,pandas,python-dateutil,pytz,tzdata
